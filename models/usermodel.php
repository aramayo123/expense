...
class UserModel extends Model implements IModel{
    ...
    function updateName($name, $iduser){
        try{
            $query = $this->db->connect()->prepare('UPDATE users SET name = :name WHERE id = :iduser');
            $query->execute([
                'name' => $name, 
                'iduser' => $iduser
            ]);
    ...
    function updatePhoto($photo, $iduser){
        try{
            $query = $this->db->connect()->prepare('UPDATE users SET photo = :photo WHERE id = :iduser');
            $query->execute([
                'photo' => $photo, 
                'iduser' => $iduser
            ]);
